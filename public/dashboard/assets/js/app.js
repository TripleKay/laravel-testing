!(function () {
    var a,
        ...
        r,
        c,
        m = document.querySelector(".navbar-menu").innerHTML,
        u = 7,
        g = "en",
    ...
    function h() {
        ...
        !a ||
            ...
            ((o = document.createElement("ul")).innerHTML =
                '<a href="#" class="logo"><img src="../../logo/logo.png" alt="" height="22"></a>'),
            document
    ...
    function w(e) {
        if (e.target && e.target.matches("a.nav-link span"))
            if (0 == p(e.target.parentElement.nextElementSibling))
                ...
                1 == p(e.target.parentElement.nextElementSibling) &&
        ...
        if (e.target && e.target.matches("a.nav-link"))
            if (0 == p(e.target.nextElementSibling))
                ...
                1 == p(e.target.nextElementSibling) &&
                1848 <= window.innerWidth
            )
                for (
                    t = document.getElementsByClassName(
                ...
                a == e.value ? (e.checked = !0) : (e.checked = !1),
                    e.addEventListener("change", function () {
                        document.documentElement.setAttribute(t, e.value),
                            ...
                            "data-layout" == t &&
                                ("vertical" == e.value
                                    ? (z("vertical"), f(), feather.replace())
                                    : "horizontal" == e.value
                                    ? (z("horizontal"), feather.replace())
                                    : "twocolumn" == e.value &&
                                      (z("twocolumn"),
                                      document.documentElement.setAttribute(
                                          "data-layout-width",
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        s &&
            ...
            (e.addEventListener("focus", function () {
                0 < e.value.length
                    ? (d.classList.add("show"), s.classList.remove("d-none"))
                    : (d.classList.remove("show"), s.classList.add("d-none"));
            }),
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((o = {}),
                  (t = e.attributes)["data-date-format"] &&
                      (o.dateFormat = t["data-date-format"].value.toString()),
                  t["data-enable-time"] &&
                      ((o.enableTime = !0),
                      (o.dateFormat =
                  ...
                  t["data-altFormat"] &&
                      ((o.altInput = !0),
                      (o.altFormat = t["data-altFormat"].value.toString())),
                  t["data-minDate"] &&
                      ((o.minDate = t["data-minDate"].value.toString()),
                      (o.dateFormat = t["data-date-format"].value.toString())),
                  t["data-maxDate"] &&
                      ((o.maxDate = t["data-maxDate"].value.toString()),
                      (o.dateFormat = t["data-date-format"].value.toString())),
                  t["data-deafult-date"] &&
                      ((o.defaultDate =
                  ...
                  t["data-inline-date"] &&
                      ((o.inline = !0),
                      (o.defaultDate = t["data-deafult-date"].value.toString()),
                      (o.dateFormat = t["data-date-format"].value.toString())),
                  t["data-disable-date"] &&
                      ((a = []).push(t["data-disable-date"].value),
                      (o.disable = a.toString().split(","))),
                  flatpickr(e, o))
