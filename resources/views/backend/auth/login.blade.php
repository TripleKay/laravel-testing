...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <head>
        ...
        <!-- App Css-->
        <link href="{{asset('dashboard/assets/css/app.min.cs')}}s" rel="stylesheet" type="text/css" />
        <!-- custom Css-->
        ...
        {{-- Image Upload --}}
        <link href="{{ asset('dashboard/assets/css/image-uploader.min.css') }}" rel="stylesheet">
    </head>
    ...
    <body>
        ...
        <!-- prismjs plugin -->
        {{-- <script src="{{asset('dashboard/assets/libs/prismjs/prism.j')}}s"></script> --}}

        <!-- gridjs js -->
        <script src="{{asset('dashboard/assets/libs/gridjs/gridjs.umd.js')}}"></script>
        <!-- gridjs init -->
        <script src="{{asset('dashboard/assets/js/pages/gridjs.init.js')}}"></script>
